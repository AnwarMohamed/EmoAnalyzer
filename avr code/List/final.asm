...
; 0000 0087         if(c == '1')
	...
	BRNE _0x6
; 0000 0088           {
; 0000 0089           PORTB.1=1 ; PORTB.2=0; PORTB.3=0;
	SBI  0x18,1
	RJMP _0x26
; 0000 008A           }
; 0000 008B         else if (c == '2')
_0x6:
	CPI  R17,50
	BRNE _0xE
; 0000 008C           {
; 0000 008D            PORTB.1=0 ; PORTB.2=1; PORTB.3=0;
	CBI  0x18,1
	SBI  0x18,2
	RJMP _0x27
; 0000 008E            }
; 0000 008F         else if (c =='3')
_0xE:
	CPI  R17,51
	BRNE _0x16
; 0000 0090           {
; 0000 0091            PORTB.1=0 ; PORTB.2=0; PORTB.3=1;
	CBI  0x18,1
	CBI  0x18,2
	SBI  0x18,3
; 0000 0092           }
; 0000 0093           else if (c =='0')
	RJMP _0x1D
_0x16:
	CPI  R17,48
	BRNE _0x1E
; 0000 0094           {
; 0000 0095           PORTB.1=0; PORTB.2=0; PORTB.3=0;
	CBI  0x18,1
_0x26:
	CBI  0x18,2
_0x27:
